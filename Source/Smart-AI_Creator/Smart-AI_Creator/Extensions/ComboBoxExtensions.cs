...
namespace Smart_AI_Creator
{
    public static class ComboBoxExtensions
    {
        ...
        public static void SetEnumValues<T>(this ComboBox cb, string noValue, string remove, bool size)
        {
            if (!typeof(T).IsEnum)
        ...
        public static void SetDbcData<T>(this ComboBox cb, Dictionary<uint, T> dict, string noValue)
        {
            if (dict == null)
                return;
